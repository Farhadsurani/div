@include('templates.header')
    <!-- header END ==== -->
     ...
     <div class="page-content bg-white">
        <!-- inner page banner -->
        <div class="page-banner ovbl-dark" style="background-image:url({{asset('public/images/banner/courses.jpeg')}});">
            <div class="container">
								 ...
								 <div class="col-md-6 col-lg-4 col-sm-6 m-b30">
									 <div class="cours-bx">
										 <div class="action-box">
												 ...
												 <a href="{{ route('web-course-details', ['id' => $field->id])}}" class="btn">Read More</a>
										 </div>
										 <div class="info-bx text-center">
											 <h5><a href="{{ route('web-course-details', ['id' => $field->id])}}">{{ $field->name }}</a></h5>
