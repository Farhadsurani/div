...
<footer>
                ...
                <div class="col-lg-4 col-md-12 col-sm-12 footer-col-4">
                    <div class="widget">
                        ...
                        <div class="subscribe-form m-b20">
                            <form class="contact-bx" method="POST" action="{{ url('/news') }}">
                                @csrf
    ...
    <div class="footer-bottom">
        <div class="container">
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 text-center"> © 2020 <span class="text-white">DAP - Diversity Awareness Program</span>  All Rights Reserved.</div>
            </div>
        </div>
    </div>
</footer>
    ...
    {{--jQuery(document).ready(function() {--}}
        ...
        {{--}else{--}}
            {{--ttrevapi = tpj("#rev_slider_486_1").show().revolution({--}}
                {{--sliderType:"standard",--}}
                {{--jsFileLocation:"{{ route('newsletter') }}",--}}
